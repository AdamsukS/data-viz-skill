...
[Code / data / documentation](../figures/figure01/README.md)

截图人工估读；柱高及误差按图估计；散点数量可能有遮挡

![空心柱状图与散点](../figures/figure01/preview.png)

原图研究背景（复用图式无需具备这些生信数据）：
...
[Code / data / documentation](../figures/figure02/README.md)

截图颜色连通区域提取的近似点；遮挡点不可恢复；椭圆由截图估读
...
[Code / data / documentation](../figures/figure03/README.md)

截图颜色连通区域提取的近似点；重叠点和组别形状无法完全识别
...
[Code / data / documentation](../figures/figure04/README.md)

均值和误差人工估读；iAUC 散点为固定种子的示例数据
...
[Code / data / documentation](../figures/figure05/README.md)

截图散点区域颜色占比估计分布，并生成示例点；不能恢复重叠样本
...
[Code / data / documentation](../figures/figure06/README.md)
...
- Control/SA 条件下，各基因型的独立样本编号和 PR1a 表达测量。
- 表达归一化公式与参考基因；若使用 qPCR，保留目标/参考 Ct 和校准样本。
- 原始误差类型、统计检验，以及新数据应采用的断轴上下范围。

## 07 · 基因表达分组柱状图

[Code / data / documentation](../figures/figure07/README.md)
...
[Code / data / documentation](../figures/figure08/README.md)

柱高和误差人工估读；示例散点由均值及误差构造，不是真实重复
...
[Code / data / documentation](../figures/figure09/README.md)
...
[Code / data / documentation](../figures/figure10/README.md)

模拟树拓扑 分支长度及叶节点注释；仅复现图式，不能用于系统发育推断
...
[Code / data / documentation](../figures/figure11/README.md)
...
[Code / data / documentation](../figures/figure12/README.md)

按截图网格估读气泡大小和颜色，非原始表达矩阵
...
[Code / data / documentation](../figures/figure13/README.md)

模拟相关散点；样本量沿用截图标签，不代表获得了原始样本
...
[Code / data / documentation](../figures/figure14/README.md)

按截图峰位 宽度 高度近似拟合的混合高斯轮廓；高度为绘图单位，非概率密度原值
...
[Code / data / documentation](../figures/figure15/README.md)

按截图峰位与多峰形态估计的混合高斯示例轮廓；不是原始流式数据
...
[Code / data / documentation](../figures/figure16/README.md)

按截图峰位与多峰形态估计的混合高斯示例轮廓；不是原始细胞表达数据

![细胞群表达山脊矩阵](../figures/figure16/preview.png)

原图研究背景（复用图式无需具备这些生信数据）：

- 每个细胞/event 的 CD161、NKG2A、CD31、CD8、CD57、CD28 表达，以及样本与 c1–c8 群标签。
- Vγ9Vδ2/Vδ1 群的定义、预处理变换、门控/聚类方法和 All cells 的组成。
- 原始样本权重及中位数的计算规则；不能从峰高推断细胞数量。

## 17 · 区域年代分布 雨云图

[Code / data / documentation](../figures/figure17/README.md)

截图分布轮廓和箱线图估读；rug 为模拟示例
...
[Code / data / documentation](../figures/figure18/README.md)

截图五数概括估读；统计标注为原图展示值，未重新做检验
...
[Code / data / documentation](../figures/figure19/README.md)

相关系数和条形人工估读，气泡按截图网格估读；非原始统计结果
...
[Code / data / documentation](../figures/figure20/README.md)
...
[Code / data / documentation](../figures/figure21/README.md)
...
[Code / data / documentation](../figures/figure22/README.md)
...
[Code / data / documentation](../figures/figure23/README.md)

构图与评估变量参考 FunDiff 论文 Figure 2；公开 CSV 由 simulate_data.py 使用固定种子 20260427 生成，用来演示样本量增加时参数分布趋近目标范围、重建误差下降的图式。它不是论文原始数据、作者 checkpoint 的输出或对论文数值的数字化提取。

![时序函数生成与完整分布评估](../figures/figure23/preview.png)

原图研究背景（复用图式无需具备这些生信数据）：

- 每个训练样本量对应的模型标识、随机种子、训练配置，以及每条生成函数的唯一 sample_id。
- 每条函数的坐标、生成值和按明确模型拟合或重建的函数值；同一 sample_id 必须共用坐标网格。
- 每条生成函数拟合得到的幅值 A、阻尼 gamma、角频率 omega、竖直位移 b，以及生成曲线与重建曲线之间的 MSE。
- 目标参数分布或可信参数边界；若真实任务没有解析参数，应替换为有定义的函数特征，而不是保留本例参数。
